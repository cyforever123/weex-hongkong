...
import hwg.com.hongkong.constants.Constants;
import hwg.com.hongkong.https.HotRefreshManager;
import hwg.com.hongkong.https.WXHttpManager;
import hwg.com.hongkong.https.WXHttpTask;
import hwg.com.hongkong.https.WXRequestListener;
import hwg.com.hongkong.util.ScreenUtil;
    ...
    httpTask.requestListener = new WXRequestListener() {
      ...
      public void onSuccess(WXHttpTask task) {
        ...
        try {
          ...
          System.out.println("==========="+new String(task.response.data, "utf-8"));
